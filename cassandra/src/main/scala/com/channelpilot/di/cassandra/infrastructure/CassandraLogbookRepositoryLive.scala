package com.channelpilot.di.cassandra.infrastructure

import com.channelpilot.di.cassandra.domain.entities.event.{Event, LogbookEntry}
import com.channelpilot.di.cassandra.domain.entities.repository.LogbookRepository
import io.getquill.*
